...
:root {
    --filter-color:
        <?php echo esc_attr($args['color']);
    ?>;
}
</style>
<div class="grid md:grid-cols-[1fr_33%] gap-4 w-full <?php echo esc_attr( $args['color'] ); ?> mb-5">
...
<div class="letter-filters p-6 rounded-md bg-[#eee]">
    <div class="flex gap-2 flex-wrap <?php echo esc_attr( $args['color'] ); ?>">
        <?php
		/** Loop from A - Z */
...
<div class="grid md:grid-cols-4 gap-3 mt-20 <?php echo esc_attr( $args['color'] ); ?> mb-5">
    ...
    <div class="grid md:grid-cols-[230px_1fr] gap-4">
        ...
        <div class="md:flex items-end">
            <div class="w-full">
                ...
                <div class="filter-category text-xs uppercase" style="margin-bottom: 0px;">
                    <?php echo get_field( 'd_subh' ); ?>
                </div>
